...
public class USNongDanAdapter extends BaseAdapter {
    Context context;
    List<NongDanModel> list;

    public USNongDanAdapter(Context context, List<NongDanModel> list) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        NongDanModel nongDanModel = (NongDanModel) getItem(i);
        viewHolder.tvID.setText(nongDanModel.getId()+"");
        viewHolder.tvUsername.setText(nongDanModel.getTaikhoan());
        viewHolder.tvName.setText(nongDanModel.getTen());
        return view;
    }
}
